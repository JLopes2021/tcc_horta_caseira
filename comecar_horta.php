...
6- Adubação
As plantas precisam tira do solo os nutrientes que ajudam para que elas cresçam. Dessa forma a medida que são colhidas, elas precisam de mais nutrientes para crescerem novamente. 
Esse é um ciclo continuo fazendo com que o solo empobreça, conseqüentemente, os nutrientes dos vegetais também. E assim a adubação se torna importante, já que pra fornece os nutrientes para as plantas em vasos
...
•	Coentro
As folhas de coentro são semelhantes à salsa, mas têm um sabor diferente e distinto. O coentro gosta de climas quentes e luz solar direta. Ao plantar, é importante manter o solo úmido; mas, uma vez bem desenvolvido, reduza a freqüência e a quantidade de regas.
...
No caso de deficiência de nutrientes, aposte na adubação orgânica freqüente. Mas, se o problema for calor excessivo, mude o vaso de lugar. Durante os períodos mais quentes do dia, mantenha a planta sob a sombra.
Se o problema for excesso de rega, a couve não conseguirá se desenvolver, por isso o melhor é recomeçar o plantio.



Sem idéias de como deixa o seu apartamento decorado? Aqui vão umas dicas!

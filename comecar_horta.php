...
Já penso em fazer sua própria horta em um espaço que está vazio em seu apartamento? Hoje iremos trazer algumas dicas sobre espaços para pode montar sua horta, dica de vasos e também do que plantar em sua horta e como cuidar dela.

1- busque locais que batem raios de sol.

Para que sua horta decerto, é preciso colocar suas plantações em um local do seu apartamento em que bata sol pelo menos 4 horas por dia escolha lugares como varando ou próximo de janelas, pois os vegetais plantados necessitam desse tempo da luz do sol para ajuda no crescimento.
...
É preciso escolher uma terra com base na qualidade do que você quer comer, as plantas necessariamente precisam de uma base rica em nutrientes para que cresçam bem. Neste sentido à terra deve ter um aspecto de esponja para ajudar na entrada de oxigênio e para manter uma boa umidade.
...
As plantas precisam tira do solo os nutrientes que ajudam elas crescerem. Dessa forma a medida que são colhidas, elas precisam de mais nutrientes para crescerem novamente. 

Esse é um ciclo contínuo fazendo com que o solo empobreça, consequentemente, os nutrientes dos vegetais também. E assim a adubação se torna importante, já que para fornece os nutrientes para as plantas em vasos
...
•	Amora
 ...
 É uma fruta com boa adaptação e que cresce de maneira semelhante ao morango.

A colheita da amora começa em outubro e vai até dezembro. Para colher, é preciso ter delicadeza

Essa e outras podem ser plantadas em vasos tem que ficar atento ao crescimento e questão da altura, pois temos alguns frutíferos que podem crescer ate 2 metros e temos os frutíferos rasteiros como o morango. Basta ficar atento na hora de escolher o tipo de frutíferos.
...
Salsa é uma planta bem delicada. Deve ser colocado em local com sombra, assim podendo receber luminosidade só não pode fica sempre exposto em luz solar. O solo deve estar sempre úmido, mas sem encharca e devido às duas raízes profundas é bom deixá-la sozinha em um vaso.
